...
"""
    algorithm43(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm43(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 4.48e+08 FLOPs
    ...
    # W19: ml5, diagonal_vector, Z18: ml3, full, tmp95: ml6, full
    # tmp96 = (W19^-1 tmp95)
    t1 = time_ns()
    ml6 ./= ml5
    t2 = time_ns()
    ...
    t_end = time_ns()
    println("$(run_id); $(t_end); algorithm43; 447916766.6666666; $(t_end-t_start)")
    # tmp24: ml7, full
    # b = tmp24
    return (ml7)
end