...
"""
    algorithm42(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm42(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 4.48e+08 FLOPs
    ...
    # y: ml2, full, L7: ml1, lower_triangular, tmp12: ml0, full, W19: ml4, diagonal_vector, Z18: ml3, full
    # tmp67 = (L7^-1 y)
    t1 = time_ns()
    trsv!('L', 'N', 'N', ml1, ml2)
    t2 = time_ns()
    ...
    # tmp12: ml0, full, W19: ml4, diagonal_vector, Z18: ml3, full, tmp67: ml2, full
    ...
    t_end = time_ns()
    println("$(run_id); $(t_end); algorithm42; 447916766.6666666; $(t_end-t_start)")
    # tmp24: ml7, full
    # b = tmp24
    return (ml7)
end