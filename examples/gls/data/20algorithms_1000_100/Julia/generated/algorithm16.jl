...
"""
    algorithm16(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm16(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 4.46e+08 FLOPs
    ...
    # X: ml0, full, tmp56: ml3, full, L7: ml1, lower_triangular, tmp70: ml2, full
    # tmp12 = (L7^-1 X)
    t1 = time_ns()
    ...
    # tmp56: ml3, full, tmp70: ml2, full, tmp12: ml0, full
    ...
    # tmp56: ml3, full, tmp70: ml2, full, tmp14: ml4, symmetric_lower_triangular
    ...
    # tmp21: ml5, full, L15: ml4, lower_triangular
    # tmp23 = (L15^-1 tmp21)
    t1 = time_ns()
    trsv!('L', 'N', 'N', ml4, ml5)
    t2 = time_ns()
    ...
    t_end = time_ns()
    println("[#LT] $(run_id); $(t_end); algorithm16; 445886667.6666666; $(t_end-t_start)")
    # tmp24: ml5, full
    # b = tmp24
    return (ml5)
end