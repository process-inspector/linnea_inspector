...
function algorithm1(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # y: ml2, full, L7: ml1, lower_triangular, tmp12: ml0, full, L15: ml3, lower_triangular
    # tmp67 = (L7^-1 y)
    t1 = time_ns()
    trsv!('L', 'N', 'N', ml1, ml2)
    t2 = time_ns()
    ...
    # tmp12: ml0, full, L15: ml3, lower_triangular, tmp67: ml2, full
    ...
    t_end = time_ns()
    println("[#LT] $(run_id); $(t_end); algorithm1; 444886666.6666666; $(t_end-t_start)")
    # tmp24: ml4, full
    # b = tmp24
    return (ml4)
end