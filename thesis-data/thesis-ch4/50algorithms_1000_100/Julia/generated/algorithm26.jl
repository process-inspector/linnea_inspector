...
"""
    algorithm26(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm26(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 4.46e+08 FLOPs
    ...
    # tmp56: ml3, full, tmp14: ml4, symmetric_lower_triangular, tmp70: ml2, full
    # (L15 L15^T) = tmp14
    t1 = time_ns()
    LAPACK.potrf!('L', ml4)
    t2 = time_ns()
    ...
    # tmp56: ml3, full, tmp70: ml2, full, L15: ml4, lower_triangular
    ...
    t_end = time_ns()
    println("[#LT] $(run_id); $(t_end); algorithm26; 445886667.6666666; $(t_end-t_start)")
    # tmp24: ml5, full
    # b = tmp24
    return (ml5)
end