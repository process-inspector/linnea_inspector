...
"""
    algorithm6(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm6(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 4.56e+08 FLOPs
    ...
    # L15: ml4, lower_triangular, tmp70: ml2, full, tmp143: ml3, full
    ...
    t_end = time_ns()
    println("$(run_id) $(t_end) algorithm6 455876667.6666666 $(t_end-t_start)")
    # tmp24: ml5, full
    # b = tmp24
    return (ml5)
end