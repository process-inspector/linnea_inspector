...
def test():
    ...
    trace_file2 = "examples/traces/gls_v2/experiments/traces/algorithm45.traces"
    ...
    alg_ranks = compute_meta_data_ranks(meta_data.get_case_data(), group_by='alg', on='duration')
