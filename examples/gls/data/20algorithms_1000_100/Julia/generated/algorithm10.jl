...
"""
    algorithm10(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm10(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 4.46e+08 FLOPs
    ...
    # X: ml0, full, L7: ml1, lower_triangular, tmp67: ml2, full
    # tmp70 = (L7^-T tmp67)
    t1 = time_ns()
    trsv!('L', 'T', 'N', ml1, ml2)
    t2 = time_ns()
    ...
    # X: ml0, full, L7: ml1, lower_triangular, tmp70: ml2, full
    ml3 = Array{Float64}(undef, 1000, 100)
    blascopy!(1000*100, ml0, 1, ml3, 1)
    # tmp12 = (L7^-1 X)
    t1 = time_ns()
    ...
    # X: ml3, full, tmp70: ml2, full, tmp12: ml0, full
    ...
    # X: ml3, full, tmp70: ml2, full, tmp14: ml4, symmetric_lower_triangular
    ...
    t_end = time_ns()
    println("[#LT] $(run_id); $(t_end); algorithm10; 445886666.6666666; $(t_end-t_start)")
    # tmp24: ml5, full
    # b = tmp24
    return (ml5)
end