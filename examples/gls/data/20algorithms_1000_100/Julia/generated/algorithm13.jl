...
"""
    algorithm13(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
function algorithm13(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # y: ml2, full, tmp56: ml3, full, L7: ml1, lower_triangular, L15: ml4, lower_triangular
    # tmp67 = (L7^-1 y)
    t1 = time_ns()
    trsv!('L', 'N', 'N', ml1, ml2)
    t2 = time_ns()
    ...
    # tmp56: ml3, full, L7: ml1, lower_triangular, L15: ml4, lower_triangular, tmp67: ml2, full
    # tmp70 = (L7^-T tmp67)
    t1 = time_ns()
    trsv!('L', 'T', 'N', ml1, ml2)
    t2 = time_ns()
    ...
    t_end = time_ns()
    println("[#LT] $(run_id); $(t_end); algorithm13; 445886667.6666666; $(t_end-t_start)")
    # tmp24: ml5, full
    # b = tmp24
    return (ml5)
end