...
"""
    algorithm11(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm11(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 4.46e+08 FLOPs
    ...
    # X: ml0, full, L7: ml1, lower_triangular, tmp21: ml3, full
    # tmp12 = (L7^-1 X)
    t1 = time_ns()
    ...
    t_end = time_ns()
    println("[#LT] $(run_id); $(t_end); algorithm11; 445886666.6666666; $(t_end-t_start)")
    # tmp24: ml3, full
    # b = tmp24
    return (ml3)
end