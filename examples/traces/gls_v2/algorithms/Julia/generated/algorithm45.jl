...
"""
    algorithm45(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm45(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 4.48e+08 FLOPs
    ...
    # tmp12: ml0, full, tmp14: ml3, symmetric_lower_triangular, tmp67: ml2, full
    ...
    # tmp12: ml0, full, tmp67: ml2, full, W19: ml4, diagonal_vector, Z18: ml3, full
    ...
    t_end = time_ns()
    println("$(run_id); $(t_end); algorithm45; 447916766.6666666; $(t_end-t_start)")
    # tmp24: ml7, full
    # b = tmp24
    return (ml7)
end