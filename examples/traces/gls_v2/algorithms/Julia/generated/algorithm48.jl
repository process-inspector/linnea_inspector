...
"""
    algorithm48(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm48(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 4.48e+08 FLOPs
    ...
    t_end = time_ns()
    println("$(run_id); $(t_end); algorithm48; 447916766.6666666; $(t_end-t_start)")
    # tmp24: ml7, full
    # b = tmp24
    return (ml7)
end