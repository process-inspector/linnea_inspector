...
"""
    algorithm24(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm24(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 4.46e+08 FLOPs
    ...
    # X: ml0, full, tmp56: ml3, full, L2: ml1, lower_triangular, tmp70: ml2, full
    ...
    # X: ml0, full, L2: ml1, lower_triangular, tmp21: ml4, full
    # tmp12 = (L2^-1 X)
    t1 = time_ns()
    ...
    # tmp21: ml4, full, L15: ml5, lower_triangular
    # tmp23 = (L15^-1 tmp21)
    t1 = time_ns()
    trsv!('L', 'N', 'N', ml5, ml4)
    t2 = time_ns()
    ...
    # L15: ml5, lower_triangular, tmp23: ml4, full
    # tmp24 = (L15^-T tmp23)
    t1 = time_ns()
    trsv!('L', 'T', 'N', ml5, ml4)
    t2 = time_ns()
    ...
    t_end = time_ns()
    println("[#LT] $(run_id); $(t_end); algorithm24; 445886667.6666666; $(t_end-t_start)")
    # tmp24: ml4, full
    # b = tmp24
    return (ml4)
end