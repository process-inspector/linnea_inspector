...
"""
    algorithm22(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm22(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 4.46e+08 FLOPs
    ...
    t_end = time_ns()
    println("$(run_id); $(t_end); algorithm22; 445886667.6666666; $(t_end-t_start)")
    # tmp24: ml5, full
    # b = tmp24
    return (ml5)
end