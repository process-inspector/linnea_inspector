...
function algorithm19(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    ...
    # X: ml0, full, tmp56: ml3, full, L2: ml1, lower_triangular, tmp67: ml2, full
    # tmp12 = (L2^-1 X)
    t1 = time_ns()
    ...
    # tmp56: ml3, full, L2: ml1, lower_triangular, tmp67: ml2, full, tmp12: ml0, full
    ...
    # tmp56: ml3, full, L2: ml1, lower_triangular, tmp67: ml2, full, tmp14: ml4, symmetric_lower_triangular
    # (L15 L15^T) = tmp14
    t1 = time_ns()
    LAPACK.potrf!('L', ml4)
    t2 = time_ns()
    ...
    # tmp56: ml3, full, L2: ml1, lower_triangular, tmp67: ml2, full, L15: ml4, lower_triangular
    # tmp70 = (L2^-T tmp67)
    t1 = time_ns()
    trsv!('L', 'T', 'N', ml1, ml2)
    t2 = time_ns()
