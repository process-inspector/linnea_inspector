...
"""
    algorithm36(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
...
"""                    
function algorithm36(ml0::Array{Float64,2}, ml1::Array{Float64,2}, ml2::Array{Float64,1})
    # cost: 4.47e+08 FLOPs
    ...
    # tmp12: ml0, full, tmp67: ml2, full, Q16: ml3, QRfact_Q, R17: ml3, QRfact_R
    ...
    t_end = time_ns()
    println("[#LT] $(run_id); $(t_end); algorithm36; 447230000.0; $(t_end-t_start)")
    # tmp24: ml6, full
    # b = tmp24
    return (ml6)
end